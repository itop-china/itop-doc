...
更详细的组织管理说明请参考 [管理组织](./managing-organizations/)。
...
iTop实例现在已准备就绪。你可以查看 [通知配置](https://www.itophub.io/wiki/page?id=3_2_0:implementation:start "3_0_0:admin:notifications") 设置工单邮件通知的方法。

---
原文：<https://www.itophub.io/wiki/page?id=3_2_0:implementation:start> 

版本：3_2_0/implementation/start.txt · Last modified: 2024/09/10 10:25 by 127.0.0.1
